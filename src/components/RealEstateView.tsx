      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center mb-16">
          <ScrollReveal animation="fade-up" threshold={0.1}>
            <div className="inline-flex items-center gap-2 rounded-full border border-teal-500/25 bg-teal-500/10 px-4 py-2 text-xs font-bold uppercase tracking-widest text-teal-400 mb-6">
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={feature.title} className="p-6 rounded-2xl border border-slate-800/70 bg-slate-900/40 hover:border-teal-500/40 transition-all">
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <div className="rounded-3xl border border-slate-800/70 bg-slate-900/40 p-8">
            <h2 className="text-2xl font-bold text-white mb-6">Real Estate Technology Solutions</h2>
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={stat.label} className="p-6 rounded-2xl border border-slate-800/70 bg-slate-900/40 text-center hover:border-teal-500/40 transition-all">
                <div className="flex justify-center mb-3 text-teal-400">{stat.icon}</div>
        ...
        {/* Case Study */}
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <div className="rounded-3xl border border-slate-800/70 bg-gradient-to-br from-teal-500/10 to-cyan-500/10 p-8">
            <h2 className="text-2xl font-bold text-white mb-6">Success Story: Property Management Firm</h2>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-teal-400 mb-4">Challenge</h3>
                <p className="text-slate-300 mb-4 leading-relaxed">
                  A property management firm struggled with manual processes, scattered data, and poor tenant communication.
                </p>
                
                <h3 className="text-lg font-semibold text-teal-400 mb-4">Solution</h3>
                <p className="text-slate-300 mb-4 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-teal-400 mb-4">Results</h3>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-slate-900/50">
                  <p className="text-xs text-slate-400 mb-1">Efficiency Gain</p>
                  <p className="text-2xl font-bold text-white">+50%</p>
                  <p className="text-xs text-teal-400 mt-1">operational efficiency</p>
                </div>
                <div className="p-4 rounded-xl bg-slate-900/50">
                  <p className="text-xs text-slate-400 mb-1">Paperwork Reduction</p>
                  <p className="text-2xl font-bold text-white">70%</p>
                  <p className="text-xs text-teal-400 mt-1">less manual work</p>
                </div>
                <div className="p-4 rounded-xl bg-slate-900/50">
                  <p className="text-xs text-slate-400 mb-1">Lead Generation</p>
                  <p className="text-2xl font-bold text-white">3x</p>
                  <p className="text-xs text-teal-400 mt-1">increase</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="text-center">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-teal-500 to-cyan-500 px-8 py-3 text-sm font-bold text-white shadow-lg shadow-teal-500/25 transition-all hover:scale-[1.02] hover:shadow-teal-500/40"
          >
