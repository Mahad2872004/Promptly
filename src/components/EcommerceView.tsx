      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center mb-16">
          <ScrollReveal animation="fade-up" threshold={0.1}>
            <div className="inline-flex items-center gap-2 rounded-full border border-pink-500/25 bg-pink-500/10 px-4 py-2 text-xs font-bold uppercase tracking-widest text-pink-600 dark:text-pink-400 mb-6">
              <ShoppingCart className="h-3 w-3" />
              E-commerce Focus
            </div>
            <p className="script-tagline mb-3">Every chat, an order.</p>
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <RevealGroup className="grid grid-cols-1 md:grid-cols-3 gap-6" itemClassName="h-full">
            {[
              ...
              <div key={feature.title} className="p-6 rounded-2xl border border-slate-200 dark:border-slate-800/70 bg-white/90 dark:bg-slate-900/40 hover:border-pink-500/40 transition-all shadow-md dark:shadow-none">
                <div className="flex items-center gap-3 mb-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-pink-500/10 to-pink-500/5">
                    <span className="text-pink-600 dark:text-pink-400">{feature.icon}</span>
                  </div>
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <div className="rounded-3xl border border-slate-200 dark:border-slate-800/70 bg-white/90 dark:bg-slate-900/40 p-8 shadow-lg dark:shadow-none">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">E-commerce Solutions We Deliver</h2>
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <RevealGroup className="grid grid-cols-2 md:grid-cols-4 gap-4" itemClassName="h-full">
            {[
              ...
              <div key={stat.label} className="p-6 rounded-2xl border border-slate-200 dark:border-slate-800/70 bg-white/90 dark:bg-slate-900/40 text-center hover:border-pink-500/40 transition-all shadow-sm dark:shadow-none">
                <div className="flex justify-center mb-3 text-pink-600 dark:text-pink-400">{stat.icon}</div>
        ...
        {/* Case Study */}
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <div className="rounded-3xl border border-pink-500/20 bg-white/90 dark:bg-slate-900 dark:bg-gradient-to-br dark:from-pink-950/40 dark:to-rose-950/40 p-8 shadow-lg dark:shadow-none">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Success Story: Fashion Brand</h2>
            
            <RevealGroup className="grid grid-cols-1 lg:grid-cols-2 gap-8" itemClassName="h-full">
              <div>
                <h3 className="text-lg font-semibold text-pink-600 dark:text-pink-400 mb-4">Challenge</h3>
                ...
                <h3 className="text-lg font-semibold text-pink-600 dark:text-pink-400 mb-4">Solution</h3>
                <p className="text-slate-600 dark:text-slate-300 mb-4 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-pink-600 dark:text-pink-400 mb-4">Results</h3>
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={result} className="flex items-start gap-2 text-sm text-slate-600 dark:text-slate-300">
                      <CheckCircle className="h-4 w-4 text-pink-600 dark:text-pink-400 mt-0.5 flex-shrink-0" />
                      {result}
                    </li>
                  ))}
                </ul>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-900/50">
                  ...
                  <p className="text-xs text-pink-600 dark:text-pink-400 mt-1">vs previous platform</p>
                </div>
                <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-900/50">
                  <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">Page Speed</p>
                  <p className="text-2xl font-bold text-slate-900 dark:text-white">0.8s</p>
                  <p className="text-xs text-pink-600 dark:text-pink-400 mt-1">load time</p>
                </div>
                <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-900/50">
                  <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">Revenue Growth</p>
                  <p className="text-2xl font-bold text-slate-900 dark:text-white">2.5x</p>
                  <p className="text-xs text-pink-600 dark:text-pink-400 mt-1">in 6 months</p>
                </div>
              </div>
            </RevealGroup>
          </div>
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="text-center">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-600 to-rose-600 dark:from-pink-500 dark:to-rose-500 px-8 py-3 text-sm font-bold text-white shadow-lg shadow-pink-500/25 transition-all hover:scale-[1.02] hover:shadow-pink-500/40"
          >
