      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center mb-16">
          <ScrollReveal animation="fade-up" threshold={0.1}>
            <div className="inline-flex items-center gap-2 rounded-full border border-orange-500/25 bg-orange-500/10 px-4 py-2 text-xs font-bold uppercase tracking-widest text-orange-600 dark:text-orange-400 mb-6">
            ...
            <h1 className="display-heading font-sans text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-4">
              Empowering{" "}
              <span className="bg-gradient-to-r from-orange-600 to-orange-500 dark:from-orange-400 dark:to-orange-600 bg-clip-text text-transparent">
                Startup Success
              </span>
            </h1>
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <RevealGroup className="grid grid-cols-1 md:grid-cols-3 gap-6" itemClassName="h-full">
            {[
              ...
              <div key={feature.title} className="p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/40 hover:border-orange-500/40 transition-all shadow-md dark:shadow-none">
                <div className="flex items-center gap-3 mb-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500/10 to-orange-500/5">
                    <span className="text-orange-600 dark:text-orange-400">{feature.icon}</span>
                  </div>
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <div className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/40 p-8 shadow-md dark:shadow-none">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Your Startup Journey with Promptly</h2>
                ...
                <div key={journey.phase} className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-orange-500/20 to-orange-700/20 border border-orange-500/30 flex items-center justify-center">
                      <span className="text-orange-600 dark:text-orange-400 font-bold text-sm">{i + 1}</span>
                    </div>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-1">{journey.phase}</h3>
                    <h4 className="text-base font-semibold text-orange-600 dark:text-orange-400 mb-2">{journey.title}</h4>
                    <p className="text-sm text-slate-600 dark:text-slate-400 mb-3">{journey.desc}</p>
                    <div className="flex flex-wrap gap-2">
                      {journey.items.map((item) => (
                        <span key={item} className="px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800/50 text-xs text-slate-700 dark:text-slate-300">{item}</span>
                      ))}
                    </div>
                  </div>
                </div>
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <RevealGroup className="grid grid-cols-2 md:grid-cols-4 gap-4" itemClassName="h-full">
            {[
              ...
              <div key={stat.label} className="p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/40 text-center hover:border-orange-500/40 transition-all shadow-md dark:shadow-none">
                <div className="flex justify-center mb-3 text-orange-600 dark:text-orange-400">{stat.icon}</div>
        ...
        {/* Case Study */}
        <ScrollReveal animation="fade-up" threshold={0.1} className="mb-16">
          <div className="rounded-3xl border border-slate-200 dark:border-slate-800/70 bg-white/90 dark:bg-slate-900 dark:bg-gradient-to-br dark:from-orange-950/40 dark:to-orange-900/30 p-8 shadow-md dark:shadow-none">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Success Story: FinTech Startup</h2>
            
            <RevealGroup className="grid grid-cols-1 lg:grid-cols-2 gap-8" itemClassName="h-full">
              <div>
                <h3 className="text-lg font-semibold text-orange-600 dark:text-orange-400 mb-4">Challenge</h3>
                ...
                <h3 className="text-lg font-semibold text-orange-600 dark:text-orange-400 mb-4">Solution</h3>
                <p className="text-slate-600 dark:text-slate-300 mb-4 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-orange-600 dark:text-orange-400 mb-4">Results</h3>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-900/50">
                  <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Development Time</p>
                  <p className="text-2xl font-bold text-slate-900 dark:text-white">8 weeks</p>
                  <p className="text-xs text-orange-600 dark:text-orange-400 mt-1">vs industry avg 16 weeks</p>
                </div>
                <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-900/50">
                  <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Funding Raised</p>
                  <p className="text-2xl font-bold text-slate-900 dark:text-white">$2M</p>
                  <p className="text-xs text-orange-600 dark:text-orange-400 mt-1">Seed round</p>
                </div>
                <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-900/50">
                  <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">User Growth</p>
                  <p className="text-2xl font-bold text-slate-900 dark:text-white">100k+</p>
                  <p className="text-xs text-orange-600 dark:text-orange-400 mt-1">First 3 months</p>
                </div>
              </div>
            </RevealGroup>
          </div>
        ...
        <ScrollReveal animation="fade-up" threshold={0.1} className="text-center">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-orange-600 to-orange-500 dark:from-orange-500 dark:to-orange-600 px-8 py-3 text-sm font-bold text-white shadow-lg shadow-orange-500/25 transition-all hover:scale-[1.02] hover:shadow-orange-500/40"
          >
